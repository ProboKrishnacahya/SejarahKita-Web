...
@section('content')
    ...
    <div class="container mt-3">
        <div class="row card illustration-card justify-content-around p-5">
            <div class="col">
                <div class="row">
                    <div class="col-sm-6 align-self-center">
                        <div class="row">
                            <p class="fs-5">{{ 'Belajar Jadi' }}</p>
                            <div class="d-inline">
                                <span class="fs-3 highlight">{{ 'Lebih Seru' }}</span>
                                <span class="fs-3">{{ '👌' }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 align-self-center">
                        <img src="{{ url('assets/img/ill_profile.svg') }}" alt=""
