                                ...
                                <div class="col-md-7">
                                    <div class="input-group">
                                        <input id="password" type="password"
                                            ...
                                            name="password" placeholder="Masukkan Sandi" required
                                            autocomplete="new-password"
                                            onkeyup="countCharacters(this, 'characterLengthPassword');">
                                        <span
                                            class="input-group-text border-2 border-light bg-transparent text-warning eye">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-7">
                                    <div class="input-group">
                                        ...
                                        <span
                                            class="input-group-text border-2 border-light bg-transparent text-warning eye"><i
